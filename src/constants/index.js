...
const ABOUT_LOCATION = {
  ...
  children: [
    ...
    },
    {
      ...
      description: [
        "Hey! I'm Kedar 👋, a full-stack developer who enjoys building sleek, interactive applications that actually work well.",
  ...
  children: [
    {
      ...
      kind: "file",
      fileType: "pdf",
      // Add `href` to open a hosted resume => href: "/your/resume/path.pdf",
    },
  ],
};
